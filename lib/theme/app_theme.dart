...
/// A class that contains all theme configurations for the motorcycle adventure tracking application.
class AppTheme {
  AppTheme._();

  // Adventure Motorcycle App Color Palette - Energetic Earth Tones
  ...
  static const Color secondaryLight = Color(
    0xFF2E86AB,
  ); // Calm blue for navigation
  static const Color secondaryVariantLight = Color(
    0xFF1F5F7A,
  ); // Darker blue variant
  static const Color accentLight = Color(
    0xFFA23B72,
  ); // Deep rose for achievements
  static const Color successLight = Color(
    0xFF43AA8B,
  ); // Natural green for completed achievements
  static const Color warningLight = Color(0xFFF18F01); // Warm amber for alerts
  ...
  static const Color textDisabledDark = Color(0xFF6B6B6B); // Disabled text dark

  /// Light theme optimized for outdoor motorcycle adventures
  ...
  /// Dark theme optimized for night riding and low-light conditions
  ...
  /// Helper method to build text theme optimized for motorcycle adventure app
  ...
  /// Data text theme using JetBrains Mono for GPS coordinates and statistics
  ...
  /// Custom colors for specific adventure app features
  static const Color achievementGold = Color(0xFFFFD700);
  static const Color mapTrail = Color(0xFF4285F4);
  static const Color speedometer = Color(0xFFFF6B35);
  static const Color batteryGreen = Color(0xFF43AA8B);
  static const Color batteryRed = Color(0xFFC73E1D);
  static const Color weatherSun = Color(0xFFF18F01);
  static const Color weatherRain = Color(0xFF2E86AB);
  static const Color communityActive = Color(0xFF43AA8B);
  static const Color communityOffline = Color(0xFF6B6B6B);
}
